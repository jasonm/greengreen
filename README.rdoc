...
# A comprehensive study on adaptive graph relabeling algorithms under the application of Phthalocyanine G-pigmented oxidative crosslinked enamels.
Fletcher, C., Stewart, M., Dr. Rebecca, A.
International Precedings on Software Development Velocity and Painting.
http://is.gd/q7Mc
# http://errtheblog.com/posts/13-colored-tests
